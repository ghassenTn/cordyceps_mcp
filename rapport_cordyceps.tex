...
\begin{quote}
\textbf{Archive (pré-refactorisation).} Ce rapport décrit l'ancienne surface
Query DSL. Depuis septembre 2026, le serveur expose uniquement
\texttt{code\_map}, \texttt{lookup\_symbol} et \texttt{impact}; la référence
opérationnelle actuelle est le fichier \texttt{README.md}.
\end{quote}
\thispagestyle{empty}
\newpage
